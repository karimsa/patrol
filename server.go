				...
				<body class="bg-gray-300">
					...
					<header class="bg-gray-800 py-12">
						<div class="container lg:px-20 mx-auto">
							...
							<div class="{{if (eq $data.NumServicesDown 0)}}bg-green-700{{else}}bg-red-800{{end}} shadow-sm p-5 rounded mb-4 flex items-center justify-between">
							...
							{{if not (eq $data.StatusFilter "")}}
								<a href="/" class="bg-blue-600 px-2 py-1 rounded text-white shadow text-sm ml-4">Show all</a>
							{{end}}
